...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Biscoitinhos.domain.Entidades.Compra", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Biscoitinhos.domain.Entidades.CompraItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Biscoitinhos.domain.Entidades.Fornecedor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Biscoitinhos.domain.Entidades.SKU", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Biscoitinhos.domain.Entidades.Compra", b =>
                {
                    b.HasOne("Biscoitinhos.domain.Entidades.Fornecedor", "Fornecedor")
                        .WithMany("Compras")
            ...
            modelBuilder.Entity("Biscoitinhos.domain.Entidades.CompraItem", b =>
                {
                    b.HasOne("Biscoitinhos.domain.Entidades.Compra", "Compra")
                        .WithMany("ListaItens")
                        .HasForeignKey("IdCompra")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Biscoitinhos.domain.Entidades.SKU", "SKU")
                        .WithMany("ListaItens")
                        .HasForeignKey("IdSku")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
